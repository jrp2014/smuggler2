...
smugglerPlugin clopts modSummary tcEnv = do
  ...
  where
    ...
    smuggling dflags minImpFilePath = do
      ...
      --  Read file content as a UTF-8 string (GHC accepts only ASCII or UTF-8)
      setLocaleEncoding utf8
      --- There should be no need to reread the source module
      setLocaleEncoding utf8
        ...
        Right (annsHsMod, astHsMod) -> do
          ...
          runParser dflags minImpFilePath minImpFileContents >>= \case
            ...
            Right (annsImpMod, L _ impMod) -> do
              ...
              -- Minimal imports, as generated by GHC
              ...
              let (astHsMod', (annsHsMod', _locIndex), _log) = runTransform annsHsMod $
                    replaceImports annsImpMod monImports astHsMod
